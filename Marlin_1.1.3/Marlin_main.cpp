  ...
  inline void gcode_G42() {
    if (IsRunning()) {
      ...
      if (parser.seen('F') && parser.value_linear_units() > 0.0)
        ...
        #if ENABLED(BLTOUCH)      //  ************************ Important to stow BLTouch prior to moves  ************ 
...
/*
//#include "HardwareSerial.h"
SoftwareSerial HMI_SERIAL(17, 16); // declared in Marlin.h
